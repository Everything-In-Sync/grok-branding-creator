...
router.post('/export/zip', async (req, res) => {
    try {
        const { paletteIndex, palettes, contactData } = req.body;
...
function generateCSSProperties(palette) {
...
async function sendExportEmail(contactData, palette, content, exportType) {
